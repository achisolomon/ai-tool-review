...
| Feature | Token Optimizer | Manual Tracking | No Optimization |
|---------|-----------------|-----------------|-----------------|
| Token Visibility | <span class="highlight">Live dashboard</span> | Spreadsheet | None |
| Compaction Survival | <span class="highlight">Auto checkpoint</span> | Manual notes | Lost context |
| Cost Attribution | <span class="highlight">Per-subagent</span> | Aggregate only | Unknown |
| Dependencies | <span class="highlight">Zero</span> | N/A | N/A |
| Telemetry | <span class="highlight">None (local)</span> | N/A | N/A |
